...
class Start extends React.Component {
  ...
  render() {
    return (
      <Fragment>
          ...
          <main>
            <section class="intro">
              ...
              <p className="intro__subtitle" style={{ fontSize: "2.0rem" }}>
                Data is the fuel to AI and, for the same AI starts with quality
                data with good annotation, High quality training and validation
                data for AI applications
              </p>
              {/* <a href="#" class="button">Get Started</a> */}
              <img
                class="intro__illustration"
                src="https://res.cloudinary.com/alexandracaulea/image/upload/v1583497233/intro-illustration_qneuer.svg"
                alt=""
              />
            </section>
                ...
                <li>
                  ...
                  >
                    <g id="operating_system">
                      <path
                        fill="#5F6CB0"
                        d="M448,144h-1.7c6.4-12.4,9.7-26.1,9.7-40c0-48.6-39.4-88-88-88c-40.3,0-75.5,27.5-85.3,66.6
		...
		H448c17.7,0,32,14.3,32,32S465.7,224,448,224L448,224z"
                      ...
                      <path
                        fill="#5F6CB0"
                        d="M501.1,450.9c-1.5-1.8-3.7-2.9-6.1-2.9h-7V280c0-13.2-10.8-24-24-24H208c-13.2,0-24,10.8-24,24v168h-7
		...
		l-1.8-10.6H304c0,4.4,3.6,8,8,8h48c4.4,0,8-3.6,8-8h117.4L483.6,474.6z"
                      ...
                      <path
                        fill="#5F6CB0"
                        d="M104,384H88v88c0,4.4,3.6,8,8,8h56v-16h-48V384z"
                      />
                      <path
                        fill="#5F6CB0"
                        d="M368,360c0-17.7-14.3-32-32-32s-32,14.3-32,32s14.3,32,32,32S368,377.7,368,360z M320,360c0-8.8,7.2-16,16-16
		s16,7.2,16,16s-7.2,16-16,16S320,368.8,320,360z"
                      />
                      <path
                        fill="#5F6CB0"
                        d="M320,432h32c3.7,0,6.9-2.5,7.8-6.1l1.3-5.3l4.7,2.8c3.1,1.9,7.2,1.4,9.8-1.2l22.6-22.6
		...
		c-0.8,0.2-1.5,0.5-2.2,0.9L303.3,406.5z"
                      ...
                      <path
                        fill="#5F6CB0"
                        d="M236,112V96c-18.3,0-33.6,13.7-35.8,31.8l15.9,1.9C217.3,119.6,225.9,112,236,112z"
                      />
                      <path
                        fill="#5F6CB0"
                        d="M408,104h16c0-30.9-25.1-56-56-56v16C390.1,64,408,81.9,408,104z"
                      />
                    </g>
                  </svg>
                  ...
                  <p>
                    <strong>
                      Annotation - Let Edunomics bring the best of DATA Platform
                      for AI
                    </strong>
                  </p>
                </li>
                <li>
                  <svg
                    ...
                    style={{ enableBackground: "new 0 0 512.2 512.2" }}
                    xmlSpace="preserve"
                  >
                    <g transform="translate(-1 -1)">
                      <path
                        fill="#5F6CB0"
                        d="M471,248.6c13.3-72.4-8.4-172-87.7-219.4C333.2,1.1,274.1-6.4,218.6,8.5C141.7,29,85.2,84.2,67.4,156
				...
				C398,391.4,397.8,392.7,398,394.1z"
                      ...
                      <path
                        fill="#5F6CB0"
                        d="M414.9,268.1c1.2-13.2-7.8-25.1-20.8-27.5l-16.3-22.7c1-1.8,1.8-3.8,2.3-5.9l15.8-6.3
				...
				c-4.7,0-8.5-3.8-8.5-8.5c0-4.7,3.8-8.5,8.5-8.5c4.7,0,8.5,3.8,8.5,8.5S394.1,274.2,389.4,274.2z"
                  ...
                  <p>
                    <strong>
                      Developed by the best brains of world with intent to make
                      AI accessible{" "}
                    </strong>
                  </p>
                </li>
                <li>
                  ...
                  >
                    <path
                      fill="#5F6CB0"
                      d="M488,432h-24V200c0-13.2-10.8-24-24-24h-32v-20.3l85.2-72.3c3.4-2.9,3.8-7.9,0.9-11.3c-1.1-1.3-2.6-2.2-4.3-2.6
	...
	H64V271z M480,456c0,13.2-10.8,24-24,24H56c-13.2,0-24-10.8-24-24v-8h448V456z"
                    ...
                    <path
                      fill="#5F6CB0"
                      d="M136,272h16c4.4,0,8-3.6,8-8s-3.6-8-8-8h-16c-4.4,0-8,3.6-8,8S131.6,272,136,272z"
                    />
                    <path
                      fill="#5F6CB0"
                      d="M184,272h128c4.4,0,8-3.6,8-8s-3.6-8-8-8H184c-4.4,0-8,3.6-8,8S179.6,272,184,272z"
                    />
                    <path
                      fill="#5F6CB0"
                      d="M344,272h32c4.4,0,8-3.6,8-8s-3.6-8-8-8h-32c-4.4,0-8,3.6-8,8S339.6,272,344,272z"
                    />
                    <path
                      fill="#5F6CB0"
                      d="M136,400h88c4.4,0,8-3.6,8-8s-3.6-8-8-8h-88c-4.4,0-8,3.6-8,8S131.6,400,136,400z"
                    />
                    <path
                      fill="#5F6CB0"
                      d="M336,384h-80c-4.4,0-8,3.6-8,8s3.6,8,8,8h80c4.4,0,8-3.6,8-8S340.4,384,336,384z"
                    />
                    <path
                      fill="#5F6CB0"
                      d="M376,288H272c-4.4,0-8,3.6-8,8s3.6,8,8,8h104c4.4,0,8-3.6,8-8S380.4,288,376,288z"
                    />
                    <path
                      fill="#5F6CB0"
                      d="M208,288c-4.4,0-8,3.6-8,8s3.6,8,8,8h32c4.4,0,8-3.6,8-8s-3.6-8-8-8H208z"
                    />
                    <path
                      fill="#5F6CB0"
                      d="M136,304h40c4.4,0,8-3.6,8-8s-3.6-8-8-8h-40c-4.4,0-8,3.6-8,8S131.6,304,136,304z"
                    />
                    <path
                      fill="#5F6CB0"
                      d="M376,352H208c-4.4,0-8,3.6-8,8s3.6,8,8,8h168c4.4,0,8-3.6,8-8S380.4,352,376,352z"
                    />
                    <path
                      fill="#5F6CB0"
                      d="M136,368h40c4.4,0,8-3.6,8-8s-3.6-8-8-8h-40c-4.4,0-8,3.6-8,8S131.6,368,136,368z"
                    />
                    <path
                      fill="#5F6CB0"
                      d="M136,336h144c4.4,0,8-3.6,8-8s-3.6-8-8-8H136c-4.4,0-8,3.6-8,8S131.6,336,136,336z"
                    />
                    <path
                      fill="#5F6CB0"
                      d="M344,336c4.4,0,8-3.6,8-8s-3.6-8-8-8h-32c-4.4,0-8,3.6-8,8s3.6,8,8,8H344z"
                    />
            ...
            <section class="get-feedback" style={{ marginTop: 100 }}>
              ...
              <p>
                Stream data into Image Annotator and push labeled data into
                training environments. Connect your ML models to supercharge
                labeling productivity and orchestrate active learning. Image
                Annotator is API-first so you can use it as infrastructure to
                scale up.
              </p>
            </section>
            <section class="get-feedback_" style={{ marginTop: "2%" }}>
              ...
              >
                ...
                >
                  <span style={{ color: "#4f8ff0" }}>
                    {this.state.importColor}
                  </span>
                  <span>{this.state.message}</span>
                  <span style={{ color: "#f09178" }}>
          ...
          <div class="footer-container">
            <center>
              <h3 class="footer-title">
                An initiative by{" "}
                <a href="https://edunomics.in" target="_blank">
                  {" "}
                  Edunomics
                </a>{" "}
            ...
            <div>
              ...
              <center>
                <a
                  href="https://www.facebook.com/edunomics2020/"
                  target="_blank"
                  style={{ marginRight: 7 }}
                >
                ...
                <a
                  href="https://www.instagram.com/edunomics2020/"
                  target="_blank"
                  style={{ marginRight: 7 }}
                >
                ...
                <a
                  href="https://www.linkedin.com/company/edunomics/"
                  target="_blank"
                  style={{ marginRight: 7 }}
                >
                  <i class="fab fa-linkedin fa-2x"></i>
                </a>
                <a href="https://twitter.com/Edunomics2" target="_blank">
                  <i class="fab fa-twitter fa-2x"></i>
                </a>
              </center>
            </div>
            <p class="copyright">
              <small>&copy; Edunomics 2020. All Rights Reserved</small>
            </p>
          </div>
        </footer>
      </Fragment>
